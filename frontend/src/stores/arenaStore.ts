...
export const useArenaStore = create<ArenaState>((set, get) => ({
  ...
  workbenchPanels: (() => {
    ...
    const validTypes = new Set(["history","moments","notebook","prompt-dev","prompt-test","inspector","artifact","app","boundaries","corrections","episodes","doppelganger","editor","chat","filesystem","shell"]);
    try {
